        ...
        <div>
            ...
            <div className='w-full bg-background'>
                <div className='max-w-7xl mx-auto px-3 sm:px-4 lg:px-6 py-4 sm:py-6'>
                    ...
                    {showFilter && (
                        <div className='lg:hidden mb-4 bg-card border border-border rounded-lg shadow-md p-4'>
                            <FilterCard />
                        </div>
                    )}
                    ...
                    <div className='grid grid-cols-1 lg:grid-cols-4 gap-4 lg:gap-6'>
                        ...
                        <div className='hidden lg:block col-span-1'>
                            <div className='sticky top-20 bg-card border border-border rounded-lg shadow-sm'>
                                <FilterCard />
                            </div>
                        </div>
                        ...
                        <div className='col-span-1 lg:col-span-3'>
                            {
                                filterJobs.length <= 0 ? (
                                    <div className='flex items-center justify-center h-96'>
                                        <span className='text-sm sm:text-base text-muted-foreground'>Job Not Found</span>
                                    </div>
                                ) : (
                                    <div className='space-y-4'>
                                        <p className='text-xs sm:text-sm text-muted-foreground'>Showing {filterJobs.length} jobs</p>
