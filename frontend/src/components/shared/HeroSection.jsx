    ...
    return (
        <div className='text-center my-5 max-w-5xl m-auto px-4 sm:px-6'>
            <div className='flex flex-col gap-2'>
                <span className='m-auto font-medium text-red-500 bg-muted py-1 px-3 rounded-full text-xs sm:text-sm'>No. 1 Job Hunt Website</span>
            ...
            <div className='flex my-5 w-full sm:w-[75%] md:w-[45%] shadow-lg border border-border pl-3 m-auto rounded-full items-center gap-4'>
                <input
