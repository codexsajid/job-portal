            ...
            <div className="container mx-auto px-4 sm:px-6 lg:px-10">
                <div className="flex flex-col sm:flex-row justify-between items-center gap-4">
                    <div className="text-center sm:text-left">
                        ...
                        <p className="text-xs sm:text-sm text-muted-foreground">© 2024 Your Company. All rights reserved.</p>
                    </div>

                    <div className="flex space-x-3 sm:space-x-4 mt-4 sm:mt-0">
                        <a href="https://facebook.com" className="hover:text-muted-foreground/80" aria-label="Facebook">
                        ...
                        <a href="https://twitter.com" className="hover:text-muted-foreground/80" aria-label="Twitter">
                        ...
                        <a href="https://linkedin.com" className="hover:text-muted-foreground/80" aria-label="LinkedIn">
